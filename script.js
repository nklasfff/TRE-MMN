...
const uiStrings = {
    ...
    en: {
        pageTitle: 'TRE — Interactive Model',
        headerTitle: 'TRE — An Interactive Model',
        subtitle: 'Tap a circle to explore',
        ...
        welcomeDefault: { title: 'Welcome to the TRE model', howTo: 'How to use it:', li1: 'Tap a circle to explore that perspective', li2: 'Switch between the five perspectives with the buttons above' },
        ...
        onboardingDesc: 'See how TRE works through an interactive model of six perspectives \u2014 tailored to you.',
    ...
    de: {
        pageTitle: 'TRE — interaktives Modell',
        headerTitle: 'TRE — ein interaktives Modell',
        subtitle: 'Tippe auf einen Kreis, um ihn zu erkunden',
        ...
        welcomeDefault: { title: 'Willkommen beim TRE-Modell', howTo: 'So funktioniert es:', li1: 'Tippe auf einen Kreis, um diese Perspektive zu erkunden', li2: 'Wechsle mit den Schaltflächen oben zwischen den fünf Perspektiven' },
        ...
        searchTryAnother: 'Versuch einen anderen Suchbegriff oder erkunde die Themen unten',
        resultSuffix: { one: 'Ergebnis', other: 'Ergebnisse' },
        onboardingWelcome: 'Willkommen bei TRE',
        onboardingDesc: 'Entdecke, wie TRE wirkt — mit einem interaktiven Modell aus sechs Perspektiven, abgestimmt auf dich.',
        onboardingBtn: 'Jetzt starten',
        onboardingStep2Title: 'Wo möchtest du beginnen?',
        onboardingStep2Desc: 'Du kannst jederzeit wechseln',
        obDoors: [
            { mode: 'klient', title: 'Ich bin neugierig / Klient', desc: 'TRE einfach und sicher erklärt' },
            { mode: 'sclerose', title: 'Ich lebe mit MS oder chronischer Krankheit', desc: 'TRE an deine Situation angepasst' },
            { mode: 'videnskab', title: 'Ich bin Fachperson', desc: 'Neurobiologie und Forschungsgrundlage' }
        ],
        obSkip: 'Zeig mir einfach das Modell →',
        obDoorsNote: 'Body Fusion Work und Übungen findest du in der App, sobald du dich eingefunden hast.',
        langSwitch: 'Dansk',
